...
Если вы видите ошибку `MIDDLEWARE_INVOCATION_FAILED`, проверьте:
- Установлены ли переменные окружения на Vercel
- Правильные ли значения переменных
- Перезапущен ли деплой после добавления переменных
